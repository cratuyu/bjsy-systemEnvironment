...
public class WeatherInfo extends IdEntity implements Serializable {
    public WeatherInfo() {
    ...
    public String getWeatherForecast7D() {
        return AQI;
    }

    public void setWeatherForecast7D(String weatherForecast7D) {
        AQI = weatherForecast7D;
    }
